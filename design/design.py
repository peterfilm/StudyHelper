...
class Ui_Helper(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(420, 512)
        MainWindow.setMinimumSize(QtCore.QSize(420, 512))
        MainWindow.setMaximumSize(QtCore.QSize(420, 512))
        MainWindow.setFixedSize(420, 512)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.layoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 380, 472))
        ...
        self.label_kmplayer.setMinimumSize(QtCore.QSize(100, 16))
        font = QtGui.QFont("MS Shell Dlg 2", 8)
        font.setBold(True)
        font.setWeight(75)
